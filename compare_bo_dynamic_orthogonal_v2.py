...
RUN_SUFFIX = "pca_kernel_pcalowrank_dynamic_orthogonal_v2"
KERNEL_NU = 2.5
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run PCA-BO V2 with mixed-space orthogonal rescoring and official BoTorch baseline with IOH logging.",
    )
